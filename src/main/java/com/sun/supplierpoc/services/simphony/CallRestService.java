...
//        this.restTemplate = restTemplateBuilder.build();
    ...
    public ZealLoyaltyResponse zealPayment(ZealLoyaltyRequest zealPayment) {
        ...
        headers.set("API-key", "xVOXeuZdwrpuNZsvx4G7Tul2dPLyYsy2iYhboWZFLGEY9O8lzwg5LzUmBeC8YiI1");
        HttpEntity<String> entity = new HttpEntity(zealPayment, headers);
        ZealLoyaltyResponse zealLoyaltyResponse = new ZealLoyaltyResponse();
        try{
            zealLoyaltyResponse =
                this.restTemplate.postForObject(url, entity, ZealLoyaltyResponse.class);
        }catch(Exception e){
...
//        }
    ...
    public ZealRedeemResponse zealVoucher(ZealRedeemRequest zealRedeemRequest) {
        ...
        headers.set("Accept", "application/json");
        headers.set("API-key", "xVOXeuZdwrpuNZsvx4G7Tul2dPLyYsy2iYhboWZFLGEY9O8lzwg5LzUmBeC8YiI1");
        HttpEntity<String> entity = new HttpEntity(zealRedeemRequest, headers);
        ZealRedeemResponse zealRedeemResponse = new ZealRedeemResponse();

        try{
            zealRedeemResponse =
                    this.restTemplate.postForObject(url, entity, ZealRedeemResponse.class);
        }catch(Exception e){
            ObjectMapper objectMapper = new ObjectMapper();
            try {
