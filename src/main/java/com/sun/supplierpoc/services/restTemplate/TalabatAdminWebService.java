...
public class TalabatAdminWebService {
    ...
    public TalabatAdminOrder acceptService(Token token) {
        ...
        try {
            ...
            Request request = new Request.Builder()
                    .url("https://crs.me.restaurant-partners.com/api/1/deliveries/oma_97b1e702-f706-553d-afa0-e7933f9bfe1b/state")
                    .method("PUT", body)
...
//            talabatAdminOrder = gson.fromJson(loginResponse.body().string(), TalabatAdminOrder.class);
    ...
    public TalabatAdminOrder updateOrderStatus(Token token) {
        ...
        try {
            ...
            Request request = new Request.Builder()
                    .url("https://crs.me.restaurant-partners.com/api/1/deliveries/oma_97b1e702-f706-553d-afa0-e7933f9bfe1b/preparation-completion")
                    .method("POST", body)
                    .addHeader("Content-Type", "application/json")
