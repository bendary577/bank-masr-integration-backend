...
*/
 // Booked Production
//   syncDescription = "Used to sync booked production from my inventory to sun monthly.";//     SyncJobType bookedProductionSyncType = new SyncJobType(6, Constants.BOOKED_PRODUCTION, syncDescription,//               "/bookedProductionSun", new Date(), new Configuration(), account.getId());
//        syncJobTypeRepo.save(bookedProductionSyncType);
//

        // Cost of Goods
      /*  syncDescription="Used to sync Cost of Goods from  oracle hospitality reports to sun monthly. ";
        Configuration costOfGoodsConfig = new Configuration();
        SyncJobType costOfGoodsType = new SyncJobType(6,Constants.COST_OF_GOODS,syncDescription,"/costOfGoods",
...
//        syncJobTypeRepo.save(supplierSyncType);
        ...
        // OPERA New Booking
       /* String syncDescription = "Used to sync new booking from opera.";
