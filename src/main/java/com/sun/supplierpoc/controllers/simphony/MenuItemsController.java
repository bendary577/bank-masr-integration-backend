...
public class MenuItemsController {
    ...
    public Response SyncSimphonyMenuItems2(String userId, Account account, int revenueCenterID){
        Response response = new Response();
        SyncJob syncJob = null;
        try {
            SyncJobType syncJobType = syncJobTypeRepo.findByNameAndAccountIdAndDeleted(Constants.MENU_ITEMS, account.getId(), false);
            ...
            syncJob = syncJobRepo.findById("60070927e5bc3923a380c51a")
            .orElseThrow(() -> new RuntimeException("syncJob not found"));
