...
public class SalesExcelExporter {
    ...
    public SalesExcelExporter(List<SyncJobData> listUsers) {
    ...
    private void writeHeaderLine() {
        ...
        commonFunctions.createCell(row, 3, "Sales Total Credit", style);
        commonFunctions.createCell(row, 4, "Sales Total Debit", style);
