...
public class SalesFileDelimiterExporter {
    ...
    public void writeSyncData(PrintWriter writer) {
        ...
        if (syncJobType.getName().equals(Constants.SALES) || syncJobType.getName().equals(Constants.COST_OF_GOODS)
            ...
            this.extractSalesSyncJobData();
                ...
                || syncJobType.getName().equals(Constants.TRANSFERS))
    ...
    private void extractInvoicesSyncJobData() {
        ...
        for (SyncJobData syncJobData : listSyncJobData) {
            ...
            syncJobDataCSV = createInvoiceSyncJobDataObject(syncJobType, syncJobData, "D");
            if (syncJobDataCSV != null)
                this.syncJobDataCSVList.add(syncJobDataCSV);

            syncJobDataCSV = createInvoiceSyncJobDataObject(syncJobType, syncJobData, "C");
            if (syncJobDataCSV != null)
                this.syncJobDataCSVList.add(syncJobDataCSV);
    ...
    private void extractTransferSyncJobData() {
        ...
        for (SyncJobData syncJobData : listSyncJobData) {
            ...
            syncJobDataCSV = createTransferSyncJobDataObject(syncJobType, syncJobData, "D");
            if (syncJobDataCSV != null)
                this.syncJobDataCSVList.add(syncJobDataCSV);

            syncJobDataCSV = createTransferSyncJobDataObject(syncJobType, syncJobData, "C");
            if (syncJobDataCSV != null)
                this.syncJobDataCSVList.add(syncJobDataCSV);
...
//            syncJobDataCSV.description = "TAX" + syncJobDataCSV.description.substring(3, 25);
    ...
    private SyncJobDataCSV createTransferSyncJobDataObject(SyncJobType syncJobType, SyncJobData syncJobData, String CDMaker) {
...
//            }
            ...
            if (syncJobData.getData().containsKey("toCostCenterAccount")) {
                accountCode = syncJobData.getData().get("toCostCenterAccount").toString();
            } else {
                accountCode = syncJobData.getData().get("toLocation").toString();
            }
...
//            String accountCode = syncJobData.getData().get("inventoryAccount").toString();
            ...
            if (syncJobData.getData().containsKey("fromCostCenterAccount")) {
                accountCode = syncJobData.getData().get("fromCostCenterAccount").toString();
            } else {
                accountCode = syncJobData.getData().get("inventoryAccount").toString();
            }
    ...
    private SyncJobDataCSV createInvoiceSyncJobDataObject(SyncJobType syncJobType, SyncJobData syncJobData, String CDMaker) {
