...
public class OauthClientDetails implements org.springframework.security.oauth2.provider.ClientDetails {
    ...
    public OauthClientDetails(String clientId, Set<String> resourceIds, boolean secretRequired, String clientSecret,
