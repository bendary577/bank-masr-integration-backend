...
public interface TransactionRepo extends MongoRepository<Transactions, String> {
    ...
    * */
    ...
    List<Transactions> findByVoucherIdAndCodeAndAccountId(String voucherId, String code, String id, Pageable paging);
    int countToTalAmountByVoucherIdAndCodeAndAccountId(String s, String voucherId, String id);
    int countAllByVoucherIdAndCodeAndAccountId(String s, String voucherId, String id);
    ...
    int countAllByVoucherIdAndCodeAndAccountIdAndStatus(String s, String voucherId, String id, String failed);
}
